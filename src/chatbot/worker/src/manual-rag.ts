export const MANUAL_RAG_CONTEXT = [
  ...
  "Company context: worked in enterprise operations and integration environments at Loja do Sapo and iCaiu; previous systems and automation work at WR Auto Pecas.",
  "Projects (high-level): Google Auth Worker, Zoho Integration Worker, Hablla Integration Worker, Zenvia Integration Worker, SIGE Integration Worker, Omie Integration Worker, CodePulse Monorepo, OS Resource Optimizer, Multi-Tenant SaaS Platform, Cipher Gate Proxy, Event-Driven Integration Service, Aegis Sentinel, Cloud Deployment Showcase.",
  ...
  "Certifications include tracks such as Google Data Analytics, Google Cybersecurity, Google AI Essentials, Google Prompting Essentials, Datadog Foundation, and AWS Cloud Quest: Cloud Practitioner badge.",
  "Courses/certifications detailed list: Google Cybersecurity Professional Certificate(v.2); Google Data Analytics Professional Certificate(v.3); Google Data Analytics Capstone: Complete a Case Study; Google Data Analytics; Introduction to Data Analysis Using Python; Share Data Through the Art of Visualization; Analyze Data to Answer Questions; Process Data from Dirty to Clean; Prepare Data for Exploration; Ask Questions to Make Data-Driven Decisions; Accelerate Your Job Search with AI; Google Cybersecurity; Put It to Work: Prepare for Cybersecurity Jobs; Imersão Front-End com IA; Início do projeto: Como começar um projeto bem-sucedido; Automate Cybersecurity Tasks with Python; Sound the Alarm: Detection and Response; Google AI Essentials; Stay Ahead of the AI Curve; Use AI Responsibly; Discover the Art of Prompting; Maximize Productivity With AI Tools; Introduction to AI; Fundamentos do gerenciamento de projetos; Google AI Essentials V1 - Badge; Google Prompting Essentials - Badge; Google Prompting Essentials; Use AI as a Creative or Expert Partner; Speed Up Data Analysis and Presentation Building; Design Prompts for Everyday Work Tasks; AWS Cloud Quest: Cloud Practitioner - Training Badge; Start Writing Prompts like a Pro; Assets, Threats, and Vulnerabilities; Foundations: Data, Data, Everywhere; Datadog Foundation; Tools of the Trade: Linux and SQL; Foundations of Cybersecurity; Play It Safe: Manage Security Risks; Connect and Protect: Networks and Network Security; Atividade - Plugin 24.1.",
];
...
export const MANUAL_RAG_SECTIONS: Array<{ key: string; keywords: string[]; content: string[] }> = [
  ...
  },
  {
    ...
    content: [
      ...
      "Courses/certifications: Google Cybersecurity Professional Certificate(v.2); Google Data Analytics Professional Certificate(v.3); Google Data Analytics Capstone: Complete a Case Study; Google Data Analytics; Introduction to Data Analysis Using Python; Share Data Through the Art of Visualization; Analyze Data to Answer Questions; Process Data from Dirty to Clean; Prepare Data for Exploration; Ask Questions to Make Data-Driven Decisions; Accelerate Your Job Search with AI; Google Cybersecurity; Put It to Work: Prepare for Cybersecurity Jobs; Imersão Front-End com IA; Início do projeto: Como começar um projeto bem-sucedido; Automate Cybersecurity Tasks with Python; Sound the Alarm: Detection and Response; Google AI Essentials; Stay Ahead of the AI Curve; Use AI Responsibly; Discover the Art of Prompting; Maximize Productivity With AI Tools; Introduction to AI; Fundamentos do gerenciamento de projetos; Google AI Essentials V1 - Badge; Google Prompting Essentials - Badge; Google Prompting Essentials; Use AI as a Creative or Expert Partner; Speed Up Data Analysis and Presentation Building; Design Prompts for Everyday Work Tasks; AWS Cloud Quest: Cloud Practitioner - Training Badge; Start Writing Prompts like a Pro; Assets, Threats, and Vulnerabilities; Foundations: Data, Data, Everywhere; Datadog Foundation; Tools of the Trade: Linux and SQL; Foundations of Cybersecurity; Play It Safe: Manage Security Risks; Connect and Protect: Networks and Network Security; Atividade - Plugin 24.1.",
      ...
      "Credentials are represented in internal assistant context and About page structured metadata.",
    ],
  },
];